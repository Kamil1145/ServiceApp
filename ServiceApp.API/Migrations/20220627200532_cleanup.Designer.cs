...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220627200532_cleanup")]
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0c01b6f9-9157-4311-806f-26f41dbdd62d"),
                            CreatedAt = new DateTime(2022, 6, 27, 22, 5, 32, 669, DateTimeKind.Local).AddTicks(3759),
