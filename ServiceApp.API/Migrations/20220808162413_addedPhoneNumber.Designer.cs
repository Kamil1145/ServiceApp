...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220808162413_addedPhoneNumber")]
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e2e6cc44-43d2-43cc-84ba-106f459219fe"),
                            CreatedAt = new DateTime(2022, 8, 8, 18, 24, 13, 650, DateTimeKind.Local).AddTicks(8469),
