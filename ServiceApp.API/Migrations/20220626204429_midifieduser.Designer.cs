...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220626204429_midifieduser")]
    partial class midifieduser
    {
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8c51ae86-66ba-475f-899c-8a230bdda89d"),
                            CreatedAt = new DateTime(2022, 6, 26, 22, 44, 29, 203, DateTimeKind.Local).AddTicks(4699),
