...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220623203007_addedComments3")]
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("97b1ee4c-9d3f-4120-8fed-fcd263d818d1"),
                            CreatedAt = new DateTime(2022, 6, 23, 22, 30, 7, 570, DateTimeKind.Local).AddTicks(1171),
