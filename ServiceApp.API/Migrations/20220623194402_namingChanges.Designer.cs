...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220623194402_namingChanges")]
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9fafbabe-fe77-47ce-8f80-a1b0d6109fd1"),
                            CreatedAt = new DateTime(2022, 6, 23, 21, 44, 2, 558, DateTimeKind.Local).AddTicks(5561),
