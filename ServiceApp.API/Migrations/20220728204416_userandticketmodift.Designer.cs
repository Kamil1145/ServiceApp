...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220728204416_userandticketmodift")]
    partial class userandticketmodift
    {
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fd441d27-cf64-4831-8b14-2721e7af4579"),
                            CreatedAt = new DateTime(2022, 7, 28, 22, 44, 16, 438, DateTimeKind.Local).AddTicks(3417),
