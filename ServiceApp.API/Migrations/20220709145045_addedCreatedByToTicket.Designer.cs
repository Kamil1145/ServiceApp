...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220709145045_addedCreatedByToTicket")]
    partial class addedCreatedByToTicket
    {
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("87896841-6239-451e-943e-048ce95b2010"),
                            CreatedAt = new DateTime(2022, 7, 9, 16, 50, 45, 701, DateTimeKind.Local).AddTicks(2536),
