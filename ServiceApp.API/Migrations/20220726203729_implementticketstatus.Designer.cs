...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220726203729_implementticketstatus")]
    partial class implementticketstatus
    {
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aa3b230a-d4df-4885-8e93-04f631de00b4"),
                            CreatedAt = new DateTime(2022, 7, 26, 22, 37, 28, 996, DateTimeKind.Local).AddTicks(9205),
