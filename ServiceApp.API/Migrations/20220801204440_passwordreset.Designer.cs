...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220801204440_passwordreset")]
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d28bac28-9976-40da-ae8f-555297aa88ed"),
                            CreatedAt = new DateTime(2022, 8, 1, 22, 44, 40, 656, DateTimeKind.Local).AddTicks(6673),
