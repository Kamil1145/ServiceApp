...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220623183150_inheritancechanges")]
    partial class inheritancechanges
    {
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("344c45ac-bdfe-4097-ae9b-9a028213b3bb"),
                            CreatedAt = new DateTime(2022, 6, 23, 20, 31, 49, 851, DateTimeKind.Local).AddTicks(6361),
