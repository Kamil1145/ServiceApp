    ...
    public partial class namingChanges : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "Tickets",
                keyColumn: "Id",
                keyValue: new Guid("c21f16a8-c89f-4e5a-9f7b-8ba2e1cc7443"));
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "Tickets",
                newName: "IX_Tickets_ResponsibleUserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Tickets_User_ResponsibleUserId",
                table: "Tickets",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("c21f16a8-c89f-4e5a-9f7b-8ba2e1cc7443"), null, new DateTime(2022, 6, 23, 21, 36, 22, 531, DateTimeKind.Local).AddTicks(6859), null, "test ticket lorem ipsum", null, "", (short)1, "TestTicket123" });
