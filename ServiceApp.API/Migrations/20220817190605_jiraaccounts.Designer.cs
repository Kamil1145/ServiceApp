...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220817190605_jiraaccounts")]
    partial class jiraaccounts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.JiraCredentials", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9dafe656-6331-492e-a322-724a4dcbf962"),
                            CreatedAt = new DateTime(2022, 8, 17, 21, 6, 4, 858, DateTimeKind.Local).AddTicks(9132),
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.JiraCredentials", b =>
                {
                    b.HasOne("ServiceApp.Models.Entities.User", "User")
                        .WithOne("JiraCredentials")
                        .HasForeignKey("ServiceApp.Models.Entities.JiraCredentials", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
