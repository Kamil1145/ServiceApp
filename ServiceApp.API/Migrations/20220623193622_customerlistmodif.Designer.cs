...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220623193622_customerlistmodif")]
    partial class customerlistmodif
    {
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c21f16a8-c89f-4e5a-9f7b-8ba2e1cc7443"),
                            CreatedAt = new DateTime(2022, 6, 23, 21, 36, 22, 531, DateTimeKind.Local).AddTicks(6859),
