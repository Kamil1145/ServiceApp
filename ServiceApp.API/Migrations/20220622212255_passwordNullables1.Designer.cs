...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220622212255_passwordNullables1")]
    partial class passwordNullables1
    {
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b71ed573-fc95-40a6-8e2e-b4d54dce0aa1"),
                            CreatedAt = new DateTime(2022, 6, 22, 23, 22, 55, 550, DateTimeKind.Local).AddTicks(2433),
