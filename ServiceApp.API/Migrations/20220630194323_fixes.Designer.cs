...
namespace ServiceApp.API.Migrations
{
    ...
    [Migration("20220630194323_fixes")]
    partial class fixes
    {
            ...
            modelBuilder.Entity("ServiceApp.Models.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fbb502e3-edf9-4cc8-88fd-5117642041ce"),
                            CreatedAt = new DateTime(2022, 6, 30, 21, 43, 23, 364, DateTimeKind.Local).AddTicks(8688),
